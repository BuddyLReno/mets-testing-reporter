...
ActiveRecord::Schema.define(version: 2019_06_25_005940) do
  ...
  create_table "test_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "guid", null: false
    ...
    t.index ["category_id"], name: "index_test_items_on_category_id"
    t.index ["project_id"], name: "index_test_items_on_project_id"
  end
